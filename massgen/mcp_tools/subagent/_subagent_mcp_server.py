...
async def create_server() -> fastmcp.FastMCP:
    ...
    global _workspace_path, _parent_agent_id, _orchestrator_id, _parent_backend_config, _subagent_orchestrator_config, _log_directory, _max_concurrent, _default_timeout
